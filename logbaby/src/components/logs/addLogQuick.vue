<template>
  <q-card class="addLogCard">
    <div class="q-pa-md row">
      ...
      <q-tooltip anchor="top middle" self="bottom middle" :offset="[-15, -15]" v-if="saveDisabled" content-class="bg-accent">{{saveDisabled}}</q-tooltip>
      <q-list bordered class="q-my-lg text-h6 text-primary col-12">
      ...
      >
       ...
       <q-btn flat size="small" color="primary"  label="SET TO NOW" @click="setNow('startDate')"   class="self-start q-mt-none"/>
      </div>
      ...
      <q-btn flat size="small" color="primary"  label="SET TO NOW"  @click="setNow('endDate')"  class="self-start q-mt-none q-pl-md"/>
      </div>
    </div>
