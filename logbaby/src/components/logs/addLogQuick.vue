<template>
   <q-card class="addLogCard">
    ...
    <q-input v-model="startDate" color="primary" label="Start" @change="setEndDate" class="col-6 q-pr-md">
    ...
    <div class="col-10 q-mt-lg">
      <q-btn color="primary" rounded :disabled="saveDisabled" :loading="saveLoading" icon="mdi-content-save" label="SUBMIT" @click="submitLog" class="text-bold full-width">
